...
console.log("import type { Channel } from '../';");

data.forEach((entry) => {
  const name = entry.name.replace(/[^a-zA-Z0-9]+/g, ""); // Remove special characters
  const exportName = name.charAt(0).toUpperCase() + name.slice(1); // PascalCase
  console.log(
